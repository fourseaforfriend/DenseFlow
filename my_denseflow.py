...
if __name__ =='__main__':
    ...
    if mode=='run':
        pool.map(new_dense_flow,zip(video_list,flows_dirs,[step]*len(video_list),[bound]*len(video_list)),enableSecond)
    else: #mode=='debug
        new_dense_flow((video_list[0],flows_dirs[0],step,bound),enableSecond)
